...
public class FantasyCalculatorTest {
    ...
    public void testGoalkeeperIdealMatch() {
        ...
        assertEquals(26, FantasyCalculator.calcularFantasyPoints(s), "GK Ideal Match calculation failed");
    }
    ...
    public void testGoalkeeperDisasterMatch() {
        ...
        assertEquals(-3, FantasyCalculator.calcularFantasyPoints(s), "GK Disaster Match calculation failed");
    }
    ...
    public void testGoalkeeperEdgeCaseZeroMinutes() {
        ...
        assertEquals(10, FantasyCalculator.calcularFantasyPoints(s), "GK Edge Case 0 minutes calculation failed");
    }
    ...
    public void testGoalkeeperSubbedEarly() {
        ...
        // Expected: 3 + 2 + 3 + 2 = 10
        assertEquals(10, FantasyCalculator.calcularFantasyPoints(s), "GK Subbed Early calculation failed");
    }
    ...
    public void testGoalkeeperScoringGoal() {
        ...
        // Expected: 5 + 5 + 5 + 5 = 20
        assertEquals(20, FantasyCalculator.calcularFantasyPoints(s), "GK Scoring Goal calculation failed");
    }
    ...
    public void testDefenderIdealMatch() {
        ...
        // Expected: 5 + 5 + 5 + 5 = 20
        assertEquals(20, FantasyCalculator.calcularFantasyPoints(s), "DEF Ideal Match calculation failed");
    }
    ...
    public void testDefenderDisasterMatch() {
        ...
        // Expected: 5 + 0 - 5 + 0 = 0
        assertEquals(0, FantasyCalculator.calcularFantasyPoints(s), "DEF Disaster Match calculation failed");
    }
    ...
    public void testDefenderEdgeCaseFiftyNineMinutes() {
        ...
        // Expected: 3 + 1 - 3 + 2 = 3
        assertEquals(3, FantasyCalculator.calcularFantasyPoints(s), "DEF Edge Case 59 mins calculation failed");
    }
    ...
    public void testDefenderSubbedEarlyCleanSheet() {
        ...
        // Expected: 3 + 5 + 5 = 13
        assertEquals(13, FantasyCalculator.calcularFantasyPoints(s), "DEF Subbed Early Clean Sheet failed");
    }
    ...
    public void testDefenderPlaymaker() {
        ...
        assertEquals(30, FantasyCalculator.calcularFantasyPoints(s), "DEF Playmaker calculation failed");
    }
    ...
    public void testMidfielderIdealMatch() {
        ...
        assertEquals(26, FantasyCalculator.calcularFantasyPoints(s), "MID Ideal Match calculation failed");
    }
    ...
    public void testMidfielderDisasterMatch() {
        ...
        // Expected: 3 - 3 - 5 + 0 = -5
        assertEquals(-5, FantasyCalculator.calcularFantasyPoints(s), "MID Disaster Match calculation failed");
    }
    ...
    public void testMidfielderEdgeCaseExactlySixty() {
        ...
        // Expected: 5 + 2 = 7
        assertEquals(7, FantasyCalculator.calcularFantasyPoints(s), "MID Edge Case Exactly 60 calculation failed");
    }
    ...
    public void testMidfielderNoStats() {
        ...
        // Expected: 5
        assertEquals(5, FantasyCalculator.calcularFantasyPoints(s), "MID No Stats calculation failed");
    }
    ...
    public void testMidfielderAssistKing() {
        ...
        // Expected: 5 + 24 + 5 = 34
        assertEquals(34, FantasyCalculator.calcularFantasyPoints(s), "MID Assist King calculation failed");
    }
    ...
    public void testForwardHatTrick() {
        ...
        assertEquals(33, FantasyCalculator.calcularFantasyPoints(s), "FWD Hat Trick calculation failed");
    }
    ...
    public void testForwardDisasterMatch() {
        ...
        // Expected: 5 - 5 + 0 = 0
        assertEquals(0, FantasyCalculator.calcularFantasyPoints(s), "FWD Disaster Match calculation failed");
    }
    ...
    public void testForwardEdgeCaseOneMinute() {
        ...
        // Expected: 3
        assertEquals(3, FantasyCalculator.calcularFantasyPoints(s), "FWD Edge Case 1 minute calculation failed");
    }
    ...
    public void testForwardSubbedScoring() {
        ...
        // Expected: 3 + 12 + 2 = 17
        assertEquals(17, FantasyCalculator.calcularFantasyPoints(s), "FWD Subbed Scoring calculation failed");
    }
    ...
    public void testForwardAggressive() {
        ...
        assertEquals(8, FantasyCalculator.calcularFantasyPoints(s), "FWD Aggressive Player calculation failed");
    }
}
